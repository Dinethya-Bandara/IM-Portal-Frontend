...
export default function JuniorStaffProfile() {
    const navigate = useNavigate();

    // Initial user state for Junior Staff
                    ...
                    <div className="bg-white rounded-[2rem] shadow-sm p-6 max-w-[95%] mx-auto border border-white/20">
                        ...
                        <div className="flex justify-between items-start mb-5">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-slate-800 tracking-tight">Junior Staff Profile</h3>
                                    <p className="text-sm font-semibold text-slate-400 mt-0.5">View and manage your staff profile</p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col items-center mb-16">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm font-bold text-slate-600 italic">{user.position || "Staff Member"}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                                ...
                                <FormField
                                    label="Position"
                                    value={user.position || "Staff Member"}
                                    disabled={true}
                                    className="bg-slate-50 cursor-not-allowed italic font-medium"
                                />
                            </div>
