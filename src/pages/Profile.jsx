...
export default function Profile() {
    ...
    const portalName = getPortal(user.role) === "STUDENT" ? "Student Portal" : "Lecturer Portal";
                    ...
                    <div className="bg-white rounded-[2rem] shadow-sm p-12 max-w-[1200px] mx-auto border border-white/20">
                        ...
                        <div className="flex justify-between items-start mb-5">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-slate-800 tracking-tight">My Profile</h3>
                                    <p className="text-sm font-semibold text-slate-400 mt-0.5">View and manage your personal information</p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col items-center mb-16">
                            <div className="relative group">
                                <div className="h-30 w-30 rounded-full border-4 border-white shadow-xl overflow-hidden mb-6 bg-slate-100 ring-2 ring-slate-50">
                                    {tempImage ? (
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm font-bold text-slate-600 italic">{user.batch || "21/22"}</p>
                            </div>
                        </div>

                        <hr className="border-slate-50 mb-0.5" />
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
                                <FormField
                                    ...
                                    onChange={(e) => setTempName(e.target.value)}
                                    disabled={!isEditing}
                                    className={!isEditing ? "bg-slate-50 cursor-not-allowed italic" : "bg-white"}
                            ...
                            <div className="mt-6">
                                <label className="mb-2 block text-xs font-bold text-slate-700">About Me (Optional)</label>
                                <div className="w-full bg-slate-50 rounded-xl px-5 py-6 text-sm font-bold text-slate-400 italic text-center border border-slate-50">
                                    {user.about}
                                </div>
                            </div>
                        </div>
...
function PersonalIcon(p) { return <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /><rect x="3" y="11" width="18" height="11" rx="2" ry="2" opacity="0" /></svg>; }
